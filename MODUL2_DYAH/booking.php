                    ...
                    <div class="container">
                        <div class="img-card">
                            ...
                            if (empty($_GET["gambarpost"])) {
                                echo '<center><img class="img-fluid booking car prev" src="C:\Users\LEGION\Documents\Materi Kuliah\Semester 5\Praktikum WAD\MODUL 2\image\toyota rush.png"></center>';
                            } else {
                                echo 'img class="img-booking car prev" src="https://' . $_GET['gambarpost'] . '"alt="404 NOT FOUND">';
                            }
                            ?>
                        </div>
                    </div>
            ...
            <div class="col-sm-6 px-2">
                    ...
                    <form method="post" action="Mybooking.php">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="time" class="form-control" id="inputNama" placeholder="--:-- --" name="start" value="" require>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="checkbox" name="services[]" value="Machine"> Catering / $700 <br>
                                <input type="checkbox" name="services[]" value="Decoration"> Brake canvas / $450 <br>
                                <input type="checkbox" name="services[]" value="Sound"> Car tires / $250 <br>
                                </fieldset>
                            </div>
                        </div>
