...
<head>
  ...
  <head>
    ...
    <!-- <link rel="stylesheet" href="dyah_Index.css"> -->
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-1BmE4kWBq78iYhFldvKuhfTAU6auU8tT94WrHftjDbrCEXSU1oBoqyl2QvZ6jIW3" crossorigin="anonymous">
            ...
            <div class="container">
                ...
                <div class="row row gx-lg-5 align-items-center">
                    <div class="col-lg-6 mb-5 mb-lg-0">
                        <h1 class="my-2 display-0 fw-bold">Selamat Datang Di Show Room <br /><span style="color: bldyah"</span></h1>
                        <p class="lead text-muted" style="color: black;">Show Room Amanah dan Terpercaya</p>
                        <br>
                        <a style="background-color: #3563E9; color:#ffffff;" type="submit" class="btn btn-primary btn-sm" role="button" href="MyItem.php">MyCar</a>
                        <br>
                        <br>
                        <p>
                            <img src="logo-ead.png" width="100px" class="m-3">dyah_1202204057
                        </p>
                        <br>
                    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="awalan.jpg" class="d-block w-100" alt="...">
                                </div>
                            </div>
                        </div>
                    </div>
