      ...
      <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <div class="navbar-nav gap-3">
          ...
          <a class="nav-link" href="<?php if (mysqli_num_rows($hasil) > 0) {
                                      echo "./pages/List-dyah.php";
                                    } else {
                                      echo "./pages/Add-dyah.php";
                                    } ?>">My Car
          </a>
          <!-- SHOW LOGO -->
    ...
    <div class="container">
      <div class="d-flex gap-5 cont justify-content-center align-items-center">
        <div>
          ...
          <p class="mt-3">Showroom dyah .<br /> Lorem</p>
          <a href="<?php echo "./pages/Add-dyah.php";?>" class="btn btn-primary">My Car</a>
          <div class="d-flex align-items-center gap-5 mt-5">
            <img src="<?php echo "asset/images/logo-ead.png" ?>" alt="logoead" style="width:100px;">
            <p style="margin-top: 20px; font-size:14px;">dyah_NIM</p>
          </div>
        </div>
        <img src="<?php echo "asset\images\supra.jpeg" ?>" alt="mobil">
      </div>
    </div>
  </section>
  <!-- Jumbotron End -->
